...
loop:
    system("cls");
    cout << "\t\t\n<<<<<<<<<<< Now We need you to choose Car class You would like to rent >>>>>>>>>>>\n";
    cout << "\n\t\t Sedans\n";
    cout << "\t\t SUVS\n";
    cout << "\t\t Pickup Trucks\n";
    ...
    if (carclass == "Sedans" || carclass == "sedans")
    {
    ...
    else if (carclass == "SUVS" || carclass == "suvs" || carclass == "suv")
    {
    ...
    else if (carclass == "Pickup Trucks" || carclass == "Pickup" || carclass == "pickups" || carclass == "pickup")
    {
    ...
    else if (carclass == "Minivans" || carclass == "minivans" || carclass == "Vans" || carclass == "vans")
    {
...
void displaypickuptrucks(MYSQL* connect)
{
    system("cls");
    cout << "\n\t\t\t\t=============================================" << endl;
    cout << "\t\t\t\t========= Pickup Trucks Information =========" << endl;
    cout << "\t\t\t\t=============================================" << endl;
    MYSQL_RES* res;
    MYSQL_ROW row;
